...
                   : 
             Notes : Normal operation is with no command line options. Requires certutil.exe. exists on system executing script.
...
                   : 
   Original Author : Unknown via the Internet.  Modded by Tyler Applebaum for use in production environment.
...
                   : v6.00 - 05-01-18 - Major rewrite to include W2012 certificate commandlets and fix folder permission issues.
                   :
